...
class LocalEmbedder:
    ...
    def __init__(self, model_name: str = "all-MiniLM-L6-v2"):
        ...
        # Do not force HF offline mode globally; it can break downstream model
        # initialization (e.g., vLLM tokenizers). SentenceTransformers will
        # still prefer the local cache when available.
